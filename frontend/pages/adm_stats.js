export const adm_stat = {
  ...
  <div class="row">
      ...
      <div class="card text-center shadow-sm h-100">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
              <h5 class="card-title text-muted text-uppercase mb-0">Total Students</h5>
              <span class="h2 font-weight-bold mb-0">{{data1['student']}}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card text-center shadow-sm h-100">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
              <h5 class="card-title text-muted text-uppercase mb-0">Total Subjects</h5>
              <span class="h2 font-weight-bold mb-0">{{data1['subjects']}}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card text-center shadow-sm h-100">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
              <h5 class="card-title text-muted text-uppercase mb-0">Total Chapters</h5>
              <span class="h2 font-weight-bold mb-0">{{data1['chapters']}}</span>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="card text-center shadow-sm h-100">
        <div class="card-body">
          <div class="d-flex justify-content-between align-items-center mb-3">
            ...
            <div>
              <h5 class="card-title text-muted text-uppercase mb-0">Total Quiz/Attempted Quiz</h5>
              <span class="h2 font-weight-bold mb-0">{{data1['quiz']}}/{{data1['attempt']}}</span>
            </div>
          </div>
        </div>
      </div>
    ...
    `,
  async beforeMount() {
    const url = "http://127.0.0.1:5000/adm_stats_1"; // Replace with the actual URL
